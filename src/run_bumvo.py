...
from models.BUMVO import BUMVO
...
if __name__ == "__main__":
    ...
    # (1) call model
    model = BUMVO(mean_cov_estimator=mean_cov_estimator, alpha=alpha, mean_functional=mean_functional, cov_functional=cov_functional)
