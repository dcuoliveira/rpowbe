...
parser.add_argument('--use_small_data', type=str, help='use small ample stocks data', default="False")
parser.add_argument('-ay', '--all_years', type=str, help='use all years to build dataset', default="False")
parser.add_argument('-lo', '--long_only', type=str, help='use all years to build dataset', default="False")
...
if __name__ == "__main__":
    ...
    print("Running script with the following parameters: model_name: {}, use_small_data {}, all_years: {}, long_only: {}, mean_estimator: {}, covariance_estimator: {}".format(model_name, use_small_data, all_years, long_only, mean_estimator, covariance_estimator))
    ...
    # prepare dataset
    loader = CRSPSimple(use_small_data=use_small_data, all_years=all_years)
