...
parser.add_argument('-mn', '--model_name', type=str, help='model name to be used for saving the model', default="rbrangeclusmvo")
...
parser.add_argument('-min_clus', '--min_clus', type=float, help='Minimum number of clusters.', default=2)
parser.add_argument('-max_clus', '--max_clus', type=float, help='Maximum number of clusters', default=5)
...
if __name__ == "__main__":
    ...
    alpha = args.alpha
    min_clus = args.min_clus
    max_clus = args.max_clus
    ...
    for step in pbar:
        ...
        pbar.set_description("Steps: %d, Test sharpe : %1.5f, best num clusters: %d" % (step, loss.item(),model.best_num_clusters))
