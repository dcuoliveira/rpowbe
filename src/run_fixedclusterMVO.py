...
parser.add_argument('-meancove', '--mean_cov_estimator', type=str, help='name of the estimator to be used for the expected returns', default="mle")
...
if __name__ == "__main__":
    ...
    # (1) call model
    model = fixedClusterMVO(risk_aversion=1,mean_cov_estimator=mean_cov_estimator,num_boot = 200, alpha=alpha)
