...
class AutomaticCluster:
	...
	def __init__(self, data,threshold):
		self.p = sparse.csr_matrix(data[0])
		self.n = sparse.csr_matrix(data[1])
	...
	def spectral_cluster_laplacian(self, normalisation='sym_sep', eigens=None, mi=None):
